    ...
    <div class="container-shell">
      <div class="max-w-3xl">
        ...
        <p class="section-subtitle">
          Здесь собраны основные данные по аккаунту и быстрые действия, которые могут пригодиться перед входом в игру.
        </p>
      </div>
      ...
      <div class="mt-10 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div class="glass-card rounded-[32px] p-8">
          <div class="section-kicker">Скоро появится</div>
          <div class="mt-6 space-y-4">
            <div class="advantage-row">
              <div class="advantage-row__icon">01</div>
              <div>
                <p class="font-bold text-slate-900">Статистика</p>
                <p class="mt-1 text-slate-600">Позже здесь появятся основные игровые показатели.</p>
              </div>
            </div>
            ...
            <div class="advantage-row">
              ...
              <div>
                ...
                <p class="mt-1 text-slate-600">Здесь можно будет посмотреть и обновить свой скин.</p>
              </div>
            </div>
            ...
            <div class="advantage-row">
              ...
              <div>
                ...
                <p class="mt-1 text-slate-600">Позже появится форма для заявок на разрешённые клиентские моды.</p>
              </div>
            </div>
          </div>

          <p v-if="loading" class="mt-6 text-sm text-slate-500">Обновляем данные профиля...</p>
          <p
            v-if="errorMessage"
